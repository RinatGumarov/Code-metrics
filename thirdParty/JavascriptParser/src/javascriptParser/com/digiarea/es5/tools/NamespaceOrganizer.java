package javascriptParser.com.digiarea.es5.tools;
...
import javascriptParser.com.digiarea.es5.tools.IErrorManager.ErrorType;
import javascriptParser.com.digiarea.es5.visitor.VoidVisitorAdapter;
...
public class NamespaceOrganizer extends VoidVisitorAdapter<Node> {
	...
	public static void main(String[] args) {
		...
		if (src == null || dst == null) {
			...
			System.out
					.println("javascriptParser.com.digiarea.es5.tools.NamespaceOrganizer\n"
	...
	public void visit(ArrayAccessExpression n, Node ctx) throws Exception {
		...
		if ((name instanceof FieldAccessExpression || name instanceof IdentifierName)
				&& index instanceof javascriptParser.com.digiarea.es5.StringLiteral) {
			String realName = name.toString() + "."
					+ ((javascriptParser.com.digiarea.es5.StringLiteral) index).getValue();
			put(realName, ctx);
		} else {
			warnUnknown(n);
		}
