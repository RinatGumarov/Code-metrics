...
public class ClojureParser implements ClojureParserConstants {
    ...
    public static int nestiness = 0;
    public static int mxnestiness = 0;
    public static int functions = 0;
    public static int pfunctions = 0;
    public static int macros = 0;
    public static int multis = 0;
    public static int methods = 0;

    public static void main(String[] args) {
        try {

            new ClojureParser(new java.io.FileReader("sample2.clj")).S();
